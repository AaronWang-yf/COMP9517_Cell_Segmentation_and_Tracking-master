...
class Drawer:
    ...
    def serve(self, id = None):
        ...
        if id:
            ...
            image = cv2.putText(image, f'Cell ID {id}: Speed = {speed:.2f}, Total distance = {total_dist:.2f}, Net distance = {net_dist:.2f}, Confinement ratio = {confinement_ratio:.2f}', CELL_DETAILS_LOC, 1, 1, (0, 255, 0), 1)
        return image
